      ...
      <div className="bg-[#F5F2EB] flex flex-col min-[1110px]:flex-row min-h-[550px] min-[1110px]:h-[75vh] w-full">
        <div className="w-full min-[1110px]:w-[40%] flex flex-col justify-end m-6 min-[1110px]:py-0">
          ...
          <motion.button
            ...
            className="bg-[#2F2F2F] text-white px-[18px] py-[12px] rounded-full mt-6 w-fit flex items-center gap-2 cursor-pointer"
          >
            Get in Touch <GoChevronRight />
          </motion.button>
        </div>
        <div className="w-full min-[1110px]:w-[60%] relative h-[300px] min-[1110px]:h-full overflow-hidden">
          <motion.div
